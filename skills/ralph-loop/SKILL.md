...
1. Confirm preflight in-thread:
   ...
   - scope/constraints
2. Start daemon:
   - `claw-loopd start --repo <repo> --session-key <session_key> --channel discord --thread-id <thread_id> --tick-sec 60 --deliver-openclaw --max-task-loops 10 --max-runtime-sec 3600`
